...
if __name__ == "__main__":
    onnx_source_dir = r'F:\demo\Pytorch_demo\MobileFaceNet_Tutorial_Pytorch\onnx_test'
    onnx_name = 'zeng_sim.onnx'
    ...
    prototxt_path = os.path.join(onnx_source_dir, prototxt_name)
    caffemodel_path = os.path.join(onnx_source_dir, caffemodel_name)
